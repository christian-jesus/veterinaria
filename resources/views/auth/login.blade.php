...
@section('title', 'Start registering 😎')
            ...
            <div class="card bg-secondary shadow border-0">
              ...
              <div class="card-body px-lg-5 py-lg-5">
                ...
                <div class="text-center text-muted mb-2">
                    <h4>😱 Your password is incorrect ,🫤 please enter the correct password</h4>
                  </div>
                ...
                <div class="text-center text-muted mb-4">
                    <small>🐾 Health and wellness for your best friend🫡</small>
                  </div>
                @endif
                ...
                <form role="form" method="POST" action="{{ route('login') }}">
                  ...
                  <!-- formulario parte Password -->
                  <div class="form-group">
                    <div class="input-group input-group-alternative">
                      <div class="input-group-prepend">
                        <span class="input-group-text"><i class="ni ni-lock-ocircle-open"></i></span>
                      </div>
                  ...
                  <div class="custom-control custom-control-alternative custom-checkbox">
                    ...
                    <label class="custom-control-label" for=" remember">
                      <span class="text-muted">remember session</span>
                    </label>
                  </div>
