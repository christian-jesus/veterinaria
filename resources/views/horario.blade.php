        ...
        <div class="card shadow">
            <div class="card-header border-0">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="mb-0">Manage attention ⚙️</h3>
                    </div>
                    <div class="col text-right">
                        <button type="submit" class="btn btn-sm btn-primary">saving changes</button>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                @if (session('errors'))
                    <div class="alert alert-danger" role="alert">
                        The changes were made, new features were found and are as follows:
                        <ul>
                            {{ var_dump(session('errors')) }} // <-- Add this line to debug the value of session('errors')
